...
@NgModule({
  ...
  declarations: [NavbarComponent, SidebarComponent, FooterComponent, AdapptToolbarComponent],
  exports: [NavbarComponent, SidebarComponent, FooterComponent, AdapptToolbarComponent]
